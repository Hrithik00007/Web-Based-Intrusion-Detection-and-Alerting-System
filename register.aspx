        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto navbar-center" id="mySidenav">
                    ...
                    <li class="nav-item">
                        <a href="default.aspx#login" class="nav-link">Login</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <form id="registerForm" runat="server" class="bg-white p-4 rounded shadow-sm">
                        ...
                        <div class="form-group">
                            <input type="text" id="txtPhone" runat="server" class="form-control" placeholder="Phone" />
                        </div>
                        <div class="form-group">
                            <textarea id="txtAddress" runat="server" class="form-control" placeholder="Address"></textarea>
                        </div>
                        <div class="form-group">
